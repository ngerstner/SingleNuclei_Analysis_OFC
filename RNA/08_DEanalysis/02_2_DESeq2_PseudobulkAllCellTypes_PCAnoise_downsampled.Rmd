...
write.csv(pc$rotated[,c(1:10)],
          file = paste0(basedir, "tables/PCA_noise/", cluster, "_PCAnoise_perc", perc, "_rotated.csv"))
write.csv(pc$variance,
          file = paste0(basedir, "tables/PCA_noise/", cluster, "_PCAnoise_perc", perc, "_variance.csv"))
