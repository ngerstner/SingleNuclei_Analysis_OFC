...
## Author: Nathalie
##################################################
# Compare celltype specific PRS DEGs with previously identified GWAS risk genes 
...
for (ct in celltypes){
  ...
  write.table(gene_set, file = paste0(basedir, "/tables/GWASenrichment/MAGMAinput/",
                                      prs_trait, "/", ct, "_geneset.annot"),
  ...
  write.table(gene_df, file = paste0(basedir, "/tables/GWASenrichment/MAGMAinput/",
                                     prs_trait, "/", ct, "_gene_covar.txt"),
